      ...
      <main className="flex-1 max-w-[1200px] mx-auto px-4 py-12 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Перевозка негабаритных и тяжелых грузов с использованием специализированного оборудования
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 leading-relaxed">
            Специальное оборудование и опыт для доставки крупногабаритных и тяжеловесных грузов.
          </p>
        </div>
      </main>
      <ExtendedFooter />
