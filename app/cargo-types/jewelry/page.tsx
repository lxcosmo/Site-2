...
export default function JewelryCargoPage() {
  return (
      ...
      <main className="flex-1 max-w-[1200px] mx-auto px-4 py-12 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Защита и специальные условия для перевозки драгоценностей и благородных металлов
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 leading-relaxed">
            Надежная защита и страховка для ювелирных изделий и драгоценных металлов.
          </p>
        </div>
      </main>
      <ExtendedFooter />
