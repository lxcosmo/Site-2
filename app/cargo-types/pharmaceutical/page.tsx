...
export default function PharmaceuticalCargoPage() {
  return (
      ...
      <main className="flex-1 max-w-[1200px] mx-auto px-4 py-12 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Соответствие стандартам холодовой цепи и требованиям по лекарственным препаратам
          </p>
        </div>

        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 leading-relaxed">
            Полное соответствие требованиям хранения и перевозки фармацевтической продукции.
          </p>
        </div>
      </main>
      <ExtendedFooter />
